...
export class Backend implements backendInterface {
    ...
    async createRegistration(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob | null, arg5: ExternalBlob | null, arg6: ExternalBlob | null, arg7: ExternalBlob | null, arg8: string | null): Promise<Registration> {
        if (this.processError) {
            try {
    ...
    async createShortUrl(arg0: string, arg1: string): Promise<ShortUrl | null> {
        if (this.processError) {
            try {
                const result = await this.actor.createShortUrl(arg0, arg1);
    ...
    async deleteShortUrl(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteShortUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listShortUrls(): Promise<Array<ShortUrl>> {
        if (this.processError) {
            try {
    ...
    async resolveShortUrl(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.resolveShortUrl(arg0);
...
async function from_candid_Registration_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Registration): Promise<Registration> {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ShortUrl]): ShortUrl | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Registration]): Promise<Registration | null> {
    return value.length === 0 ? null : await from_candid_Registration_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: string;
    teamName: string;
    proofOfPaymentUrl: [] | [_ExternalBlob];
    whatsappLink: string;
    playerPhotoUrl: [] | [_ExternalBlob];
    referredBy: [] | [string];
    paymentScreenshotUrl: [] | [_ExternalBlob];
    response: string;
    phoneNumber: string;
    registeredAt: bigint;
    teamLogoUrl: [] | [_ExternalBlob];
}): Promise<{
    id: string;
    teamName: string;
    proofOfPaymentUrl?: ExternalBlob;
    ...
    return {
        ...
        proofOfPaymentUrl: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.proofOfPaymentUrl)),
        whatsappLink: value.whatsappLink,
        playerPhotoUrl: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.playerPhotoUrl)),
        referredBy: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.referredBy)),
        paymentScreenshotUrl: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.paymentScreenshotUrl)),
        response: value.response,
        phoneNumber: value.phoneNumber,
        registeredAt: value.registeredAt,
        teamLogoUrl: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.teamLogoUrl))
    };
}
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Registration>): Promise<Array<Registration>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Registration_n11(_uploadFile, _downloadFile, x)));
}
